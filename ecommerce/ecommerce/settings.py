...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ecommerce.context_processors.wishlist',
                'ecommerce.context_processors.site_meta',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='ShopMart <noreply@shopmart.com>')
